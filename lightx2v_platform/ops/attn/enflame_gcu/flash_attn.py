...
# Try to import Flash Attention 2 (enflame supports Flash Attention 2)
try:
...
class FlashAttnEnflameGcu(AttnWeightTemplate):
    ...
    def __init__(self, weight_name="flash_attn_enflame_gcu"):
        ...
        if self.use_flash_attn:
            logger.info("Flash Attention 2 is available and will be used for Enflame GCU.")
        else:
    ...
    def apply(
        ...
        if cu_seqlens_kv is not None and cu_seqlens_kv.dtype != torch.int32:
        ...
        # Use Flash Attention 2 with varlen interface
